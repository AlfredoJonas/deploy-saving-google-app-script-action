class BaseSource {
    ...
    proccessExpenseMessage(){
        ...
        if(pesos != null && dolar != null && bolivar != null && item.length == 4){
          ...
          sendMessage("Gasto guardado exitosamente. Tipo de cambios: Bs/USD="+bsUsd+" Bs/COP="+bsPesos+" USD/COP="+usdPesos);
        } else {
          sendMessage("ERROR: Verifique el formato del mensaje.");
        }
    }
